...
In this example, the task will fail only if the error message does not contain "No such file or directory".(in other words, agar error msg ye hai toh task execute hoga ya aise bolo ki agar error msg ye nhi hai toh task execute nhi hoga)
